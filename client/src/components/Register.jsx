...
function Register() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-purple-400/30 to-pink-600/30 rounded-full filter blur-3xl animate-pulse"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-cyan-400/30 to-blue-400/30 rounded-full filter blur-3xl animate-pulse delay-1000"></div>
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-r from-yellow-400/20 to-red-600/20 rounded-full filter blur-3xl animate-pulse delay-500"></div>
      
      {/* Quick Sign Up - Top Right */}
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="form-group">
              <label htmlFor="name" className="form-label text-xs font-medium mb-1 block">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div className="form-group">
              ...
              <input
                ...
                disabled={loading}
              />
              <p className="form-help text-xs mt-1">Must be at least 6 characters long.</p>
            </div>

            <button
              type="submit"
              disabled={loading}
              className="btn btn-primary w-full py-2.5 text-sm font-medium shadow-lg mt-4"
            >
              {loading ? (
